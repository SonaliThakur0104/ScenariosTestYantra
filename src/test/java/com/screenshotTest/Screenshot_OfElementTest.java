...
public class Screenshot_OfElementTest {
	WebDriver driver=null;
	WebDriverDataUtility webDriverDataUtility;
	FlipkartPage flipkartPage;
	String filePath="./screenshot/flipkart_WebElement.png";
	...
	public void screenShotSessionTest() {
		...
		File src=flipkartPage.webElementScreenshotDetails().getScreenshotAs(OutputType.FILE);
